...
*/
                                                                ...
                                                                /* ... (see Note #1) :                                  */
#define  NET_BUF_CFG_NBR_SMALL                             4    /* Configure total number of SMALL BUFFERs.             */
...
#define  NET_ARP_CFG_NBR_CACHE                            5    /* Configure ARP cache size.                            */
//#warning might be changed
...
#define  NET_CFG_TRANSPORT_LAYER_SEL            NET_TRANSPORT_LAYER_SEL_UDP
...
#define  NET_TCP_CFG_RX_WIN_SIZE_OCTET              (1*1460)    /* Configure TCP connection receive  window size.       */
#define  NET_TCP_CFG_TX_WIN_SIZE_OCTET              (5*1460)    /* Configure TCP connection transmit window size.       */
...
#define  NET_SOCK_CFG_NBR_SOCK                            4    /* Configure total number of sockets.                   */
//#warning might be changed
